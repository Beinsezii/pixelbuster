...
// TODO: smarter conversions, like LAB -> LCH directly
// honestly I was thinking of all kinds of solutions using Ord impls to "upgrade" or "downgrade"
// but really I think it's gonna be best to just crank them all out by hand
// using copy-paste since there's only 5 items.
